    ...
    public function add($order_index)
    {
        ...
        try {
            ...
            foreach($order_goods_array as $order_goods) {
                ...
                //锁定库存
                StGoodsStock::where([['mall_id',$mall -> id],['sku',$order_goods -> goods_sku]])
                                    ->increment('lock_number',$order_goods -> goods_number);
                $sku_list[] =  $order_goods -> goods_sku;
            }
